...
console.log({userId:req.user.id});
          ...
          const order= new Order({userId:req.user.id, sessionId: session.id, products: products, totalPrice: products.reduce((acc, current)=> acc+= current.quantity*current?.price,0), orderStatus: "processing"  })
...
module.exports={checkOut, orderFetch,sessionStatus}